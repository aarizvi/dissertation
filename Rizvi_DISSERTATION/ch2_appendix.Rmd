...
\noindent `parse_Impute2INFO/awk_Impute2.INFO_by_geneLoc_cg.sh`
...
\noindent `candidate_gene/result_files_cg/impute.results.w.typedsnps`  
...
\noindent `candidate_gene/metal_results/`.
